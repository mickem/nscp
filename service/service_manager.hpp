...
class service_manager {
 ...
 public:
  ...
  static std::string get_default_service_name() { return DEFAULT_SERVICE_NAME; }
  static std::string get_default_service_desc() { return DEFAULT_SERVICE_DESC; }
  static std::string get_default_service_deps() { return DEFAULT_SERVICE_DEPS; }
  static std::string get_default_arguments() { return "service --run"; }
  inline void print_msg(std::string str) { std::cout << str << std::endl; }
  inline void print_error(std::string str) { std::cerr << "ERROR: " << utf8::to_encoding(str, "") << std::endl; }
...
class service_manager {
 public:
  ...
  int install(std::string service_description) { return unsupported(); }
  int uninstall() { return unsupported(); }
  int start() { return unsupported(); }
  int stop() { return unsupported(); }
