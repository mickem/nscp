...
namespace nsclient {
	...
	namespace core {
		...
		void settings_query_handler::parse_inventory(const PB::Settings::SettingsRequestMessage::Request::Inventory &q, PB::Settings::SettingsResponseMessage::Response* rp) {
		...
		void settings_query_handler::recurse_find(PB::Settings::SettingsResponseMessage::Response::Query *rpp, const std::string base_path, bool recurse, bool fetch_keys) {
		...
		void settings_query_handler::parse_registration(const PB::Settings::SettingsRequestMessage::Request::Registration &q, int plugin_id, PB::Settings::SettingsResponseMessage::Response* rp) {
		...
		void settings_query_handler::parse_control(const PB::Settings::SettingsRequestMessage::Request::Control &p, PB::Settings::SettingsResponseMessage::Response* rp) {
			rp->mutable_control();
