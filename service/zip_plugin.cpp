...
struct zip_archive {
  ...
  bool read(std::string file) { return mz_zip_reader_init_file(&handle_, file.c_str(), 0); }
 ...
 */
nsclient::core::zip_plugin::zip_plugin(const unsigned int id, const boost::filesystem::path file, std::string alias, nsclient::core::path_instance paths,
