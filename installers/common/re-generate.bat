...
"C:/Program Files (x86)/WiX Toolset v3.9\bin\heat.exe" dir ..\..\op5\scripts -cg Op5ScriptResources -gg -out op5_scripts.wxs -var var.ScriptSource
"C:/Program Files (x86)/WiX Toolset v3.9\bin\heat.exe" dir ..\..\op5\config -cg Op5ConfigResources -gg -out op5_config.wxs -var var.ConfigSource
