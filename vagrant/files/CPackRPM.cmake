...
IF(RPMBUILD_EXECUTABLE)
  # Now call rpmbuild using the SPECFILE
    MESSAGE("\"${RPMBUILD_EXECUTABLE}\" -bb --define \"_topdir ${CPACK_RPM_DIRECTORY}\"  --buildroot \"${CPACK_RPM_DIRECTORY}/${CPACK_PACKAGE_FILE_NAME}${CPACK_RPM_PACKAGE_COMPONENT_PART_PATH}\" \"${CPACK_RPM_BINARY_SPECFILE}\"")
  EXECUTE_PROCESS(
