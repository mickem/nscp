...
namespace NSCP.Plugin {
    ...
    {
        public NSCP.IPlugin create(NSCP.ICore core, int plugin_id, String alias)
        {
...
//             result.data = response_message.Build().ToByteArray();
    ...
    public class MyPlugin : NSCP.IPlugin
    {
        ...
        public bool load(int mode)
        {
            ...
            String s = core.getSettings().getString("/modules/dotnet", "CSharpSimplePlugin.dll", "FooBar");
            core.getLogger().error("My value is: " + s);
