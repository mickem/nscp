...
void scripts::nscp::settings_provider_impl::set_string(std::string path, std::string key, std::string value) { settings_.set_string(path, key, value); }

bool scripts::nscp::settings_provider_impl::get_bool(std::string path, std::string key, bool value) { return settings_.get_bool(path, key, value); }

void scripts::nscp::settings_provider_impl::set_bool(std::string path, std::string key, bool value) { settings_.set_bool(path, key, value); }

int scripts::nscp::settings_provider_impl::get_int(std::string path, std::string key, int value) { return settings_.get_int(path, key, value); }

void scripts::nscp::settings_provider_impl::set_int(std::string path, std::string key, int value) { settings_.set_int(path, key, value); }
...
bool scripts::nscp::core_provider_impl::query(const std::string &request, std::string &response) { return core_->query(request, response); }
...
bool scripts::nscp::core_provider_impl::reload(const std::string module) { return core_->reload(module); }
