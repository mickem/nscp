...
class basic_command_line_parser_ex : public boost::program_options::basic_command_line_parser<charT> {
 public:
  /*
  static boost::program_options::basic_parsed_options<charT> parse_command_line(int argc, charT* argv[], const boost::program_options::options_description&
  desc, int style = 0, boost::function1<std::pair<std::string, std::string>, const std::string&> ext = boost::program_options::ext_parser())
  {
  ...
  */
  ...
  std::vector<std::basic_string<charTx> > make_vector(Iterator i, Iterator e) {
  ...
  basic_command_line_parser_ex(int argc, charT* argv[])
      : boost::program_options::basic_command_line_parser<charT>(make_vector<charT, charT**>(argv, argv + argc)) {}
  basic_command_line_parser_ex(std::vector<charT> v) : boost::program_options::basic_command_line_parser<charT>(v) {}
