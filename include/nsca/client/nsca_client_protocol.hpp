...
class protocol : public boost::noncopyable {
 ...
 private:
  ...
  enum state { none, connected, got_iv, sent_request, has_request, done };
 ...
 public:
  ...
  response_type get_timeout_response() { return false; }
  response_type get_response() { return true; }
  bool has_data() { return current_state_ == has_request || current_state_ == got_iv; }
  ...
  bool on_read_error(const boost::system::error_code&) { return false; }
};
}  // namespace client
}  // namespace nsca