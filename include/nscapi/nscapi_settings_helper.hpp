...
class settings_keys_easy_init {
 public:
  ...
  settings_keys_easy_init(std::string path, std::string parent, settings_registry* owner_, bool is_sample)
      : owner(owner_), path_(path), parent_(parent), is_sample(is_sample) {}
...
class path_extension {
 public:
  ...
  settings_keys_easy_init add_key_to_path(std::string path) { return settings_keys_easy_init(get_path(path), owner_, is_sample); }
  settings_keys_easy_init add_key() { return settings_keys_easy_init(path_, owner_, is_sample); }
  settings_paths_easy_init add_path(std::string path = "") { return settings_paths_easy_init(get_path(path), owner_, is_sample); }
...
class alias_extension {
 public:
  ...
  settings_keys_easy_init add_key_to_path(std::string path) { return settings_keys_easy_init(get_path(path), parent_, owner_); }
  settings_paths_easy_init add_path(std::string path) { return settings_paths_easy_init(get_path(path), owner_); }
  std::string get_path(std::string path = "") const {
    if (path.empty()) return "/" + alias_;
    return path + "/" + alias_;
  }

  settings_keys_easy_init add_key_to_settings(std::string path = "") { return settings_keys_easy_init(get_settings_path(path), parent_, owner_); }
  settings_paths_easy_init add_path_to_settings(std::string path = "") { return settings_paths_easy_init(get_settings_path(path), owner_); }
  settings_tpl_easy_init add_templates(std::string path = "") { return settings_tpl_easy_init(get_settings_path(path), owner_); }
  ...
  void set_alias(std::string cur, std::string def) { alias_ = get_alias(cur, def); }
  void set_alias(std::string prefix, std::string cur, std::string def) { alias_ = get_alias(prefix, cur, def); }
  void set_parent_path(std::string parent) { parent_ = parent; }
...
class settings_registry {
 ...
 public:
  ...
  void add(boost::shared_ptr<key_info> info) { keys_.push_back(info); }
  void add(boost::shared_ptr<tpl_info> info) { tpl_.push_back(info); }
  void add(boost::shared_ptr<path_info> info) { paths_.push_back(info); }

  settings_keys_easy_init add_key() { return settings_keys_easy_init(this); }
  settings_keys_easy_init add_key_to_path(std::string path) { return settings_keys_easy_init(path, this); }
  settings_keys_easy_init add_key_to_settings(std::string path) { return settings_keys_easy_init("/settings/" + path, this); }
  settings_paths_easy_init add_path() { return settings_paths_easy_init(this); }
  settings_paths_easy_init add_path_to_settings() { return settings_paths_easy_init("/settings", this); }

  void set_alias(std::string cur, std::string def) { alias_ = alias_extension::get_alias(cur, def); }
  void set_alias(std::string prefix, std::string cur, std::string def) { alias_ = alias_extension::get_alias(prefix, cur, def); }
  void set_alias(std::string alias) { alias_ = alias; }
  alias_extension alias() { return alias_extension(this, alias_); }
  alias_extension alias(std::string alias) { return alias_extension(this, alias); }
  alias_extension alias(std::string cur, std::string def) { return alias_extension(this, alias_extension::get_alias(cur, def)); }
  alias_extension alias(std::string prefix, std::string cur, std::string def) { return alias_extension(this, alias_extension::get_alias(prefix, cur, def)); }

  path_extension path(std::string path) { return path_extension(this, path); }
