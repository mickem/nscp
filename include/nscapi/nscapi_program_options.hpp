...
inline po::options_description create_desc(const PB::Commands::QueryRequestMessage::Request &request) { return create_desc(request.command()); }
inline po::options_description create_desc(const PB::Commands::ExecuteRequestMessage::Request &request) { return create_desc(request.command()); }
...
*/
static void format_paragraph(std::ostream &os, std::string par, std::size_t indent, std::size_t line_length) {
...
static void format_description(std::ostream &os, const std::string &desc, std::size_t first_column_width, unsigned line_length) {
...
inline std::string help_pb(const po::options_description &desc) { return help_pb(desc, field_map()); }
