...
namespace nrpe {
	...
	public:
		...
		static size_type get_packet_length_v2() {
			return get_packet_length_v2(payload_length_);
		}
		static size_type get_min_header_length() {
			return sizeof(nrpe::data::packet_header);
		}
		static size_type get_packet_length_v2(size_type payload_length) {
			return sizeof(nrpe::data::packet_v2) + payload_length * sizeof(char);
		}
		static size_type get_packet_length_v3(size_type payload_length) {
			return sizeof(nrpe::data::packet_v3) + payload_length * sizeof(char) - 1;
		}
		static size_type get_packet_length_v4(size_type payload_length) {
			return sizeof(nrpe::data::packet_v3) + payload_length * sizeof(char) - 4;
		}
		static size_type get_payload_length() {
			return payload_length_;
		}
		static size_type get_payload_length(size_type packet_length) {
			return (packet_length - sizeof(nrpe::data::packet_v2)) / sizeof(char);
		}
	};
	...
	public:
		...
		static const char* payload_offset(const nrpe::data::packet_v2* p) {
			return &reinterpret_cast<const char*>(p)[nrpe::data::buffer_offset_v2];
		}
		static const char* payload_offset(const nrpe::data::packet_v3* p) {
			return &reinterpret_cast<const char*>(p)[nrpe::data::buffer_offset_v3];
		}
