...
struct unary_fun : public any_node, boost::enable_shared_from_this<unary_fun> {
 ...
 public:
  ...
  virtual value_type infer_type(object_converter converter, value_type) { return infer_type(converter); }
  virtual value_type infer_type(object_converter converter) { return type_tbd; }
