...
class log_driver_interface_impl : public log_driver_interface {
 ...
 public:
  ...
  virtual bool is_console() const { return console_log_; }
  bool is_oneline() const { return oneline_; }
  bool is_no_std_err() const { return no_std_err_; }
  ...
  bool is_started() const { return is_running_; }
...
class logger_impl : public nsclient::logging::logger {
 ...
 public:
  ...
  bool should_trace() const { return level_.should_trace(); }
  bool should_debug() const { return level_.should_debug(); }
  bool should_info() const { return level_.should_info(); }
  bool should_warning() const { return level_.should_warning(); }
  ...
  std::string get_log_level() const { return level_.get(); }
