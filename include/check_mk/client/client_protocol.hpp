...
class protocol : public boost::noncopyable {
 ...
 public:
  ...
  void prepare_request(request_type&) { set_state(wants_response); }

  write_buffer_type& get_outbound() { return read_buffer_; }
  read_buffer_type& get_inbound() { return read_buffer_; }

  response_type get_timeout_response() { return check_mk::packet(); }
  ...
  bool on_write(std::size_t) { return true; }
};
}  // namespace client
}  // namespace check_mk