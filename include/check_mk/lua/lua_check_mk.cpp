...
const luaL_Reg mk_ctors[] = {
    { "new", &check_mk::check_mk_lua_wrapper::create },
    { 0 }
};
...
const luaL_Reg packet_functions[] = {
    ...
    {0}};
const luaL_Reg packet_ctors[] = {
    { "new", &check_mk::check_mk_packet_wrapper::create },
    { 0 }
};
...
const luaL_Reg section_functions[] = {
...
const luaL_Reg section_ctors[] = {
    { "new", &check_mk::check_mk_section_wrapper::create },
    { 0 }
};
...
const luaL_Reg line_ctors[] = {
    { "new", &check_mk::check_mk_line_wrapper::create },
    { 0 }
};
