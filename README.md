 ...
 * Windows (standard build): Windows 10 / Server 2016 and later. Built with Microsoft's `v143` build tools (Visual Studio 2022).
 * Windows (legacy build): Windows XP and later, best-effort. Built with Microsoft's older `v141_xp` build tools for machines that cannot move to a supported version of Windows.
...
|--------------------------------|---------------------------------------------------|------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Windows (modern)               | Windows 10 / 11, Server 2016 / 2019 / 2022 / 2025 | x64 (64-bit)     | `NSCP-<version>-x64.msi`                         | Recommended for all modern Windows systems. Built with Microsoft's `v143` build tools (Visual Studio 2022).                                                      |
| Windows (modern)               | Windows 10 / 11, Server 2016 / 2019 / 2022 / 2025 | x86 (32-bit)     | `NSCP-<version>-Win32.msi`                       | Use only on 32-bit Windows installations. Built with Microsoft's `v143` build tools (Visual Studio 2022).                                                        |
| Windows (modern)               | Windows 11 ARM, Server 2025 ARM                   | ARM64            | `NSCP-<version>-ARM64.msi`                       | Native ARM64 build (Microsoft's `v143` build tools). Use this on Windows-on-ARM devices (e.g. Surface Pro X / Copilot+ PCs, ARM-based Azure VMs).                |
| Windows (legacy)               | Windows XP and above                              | x86 (32-bit)     | `NSCP-<version>-Win32-legacy-xp.msi`             | Self-contained (no separate Microsoft Visual C++ Runtime to install), built with Microsoft's older `v141_xp` build tools. Use this on any Windows older than Windows 10 / Server 2016. Works on x64 versions of these older systems too. |
