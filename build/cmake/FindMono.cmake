...
if(WIN32)
  ...
  # default version get_filename_component( test
    ...
    if(csharp_mono_valid)
      ...
      if(EXISTS "${csharp_mono_bin_dir}/mono.exe")
        set(CSHARP_MONO_INTERPRETER_${csharp_mono_version_temp}
            ...
            CACHE STRING "C# Mono interpreter ${csharp_mono_version_temp}"
                  FORCE)
  ...
  set(chsarp_mono_names
      ...
      "gmcs"
      "gmcs.exe")
  set(csharp_mono_paths "/usr/bin/" "/usr/local/bin/" "/usr/lib/mono/2.0"
                        "/opt/novell/mono/bin")
  find_program(
