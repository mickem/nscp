...
if(PROTOBUF_LIBRARY
  ...
  find_path(
    ...
    PATHS ${PROTOBUF_ROOT} ${PROTOBUF_ROOT}/src /usr/include /usr/local/include
          /usr/local/Cellar/protobuf241/2.4.1/include)
  if(NOT PROTOBUF_INCLUDE_DIR)
    # Attempt to find a source folder if we did not find the include oine
    find_path(PROTOBUF_INCLUDE_DIR google/protobuf/package_info.h
  ...
  find_library(
    ...
    NAMES ${PROTOBUF_LIBRARY_PREFIX}protobuf${PROTOBUF_LIBRARY_SUFFIX}
  ...
  set(PROTOBUF_LIBRARY debug ${PROTOBUF_LIBRARY_DEBUG} optimized
                       ${PROTOBUF_LIBRARY_RELEASE})
  ...
  if(NOT PROTOBUF_PROTOC_EXECUTABLE)
    find_program(
      ...
      PATHS ${PROTOBUF_BINARYDIR} ${PROTOBUF_ROOT}/cmake/solution/Release
  ...
  if(PROTOBUF_PROTOC_EXECUTABLE)
    ...
    string(REGEX REPLACE "[a-z]+ ([0-9.]+)$" "\\1" PROTOBUF_PROTOC_VERSION
                         ${TMP_VERSION})
  endif()
  ...
  set(PROTOBUF_INCLUDE_DIR
      ...
      CACHE INTERNAL "The protocol buffers include path")
  set(PROTOBUF_LIBRARY
      ${PROTOBUF_LIBRARY}
      CACHE INTERNAL "The libraries needed to use protocol buffers library")
  set(PROTOBUF_PROTOC_EXECUTABLE
      ${PROTOBUF_PROTOC_EXECUTABLE}
      CACHE INTERNAL "The protocol buffers compiler")
  set(PROTOBUF_PROTOC_VERSION
      ${PROTOBUF_PROTOC_VERSION}
      CACHE INTERNAL "The protocol buffers version")
