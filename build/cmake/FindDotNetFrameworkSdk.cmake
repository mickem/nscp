...
#
# The following variables are set: CSHARP_DOTNET_FOUND
# CSHARP_DOTNET_COMPILER_${version} eg. "CSHARP_DOTNET_COMPILER_v4.0.30319"
# CSHARP_DOTNET_VERSION eg. "v4.0.30319" CSHARP_DOTNET_VERSIONS eg. "v2.0.50727,
...
# C# Compiler options:
# http://msdn.microsoft.com/en-us/library/2fdbz5xd(v=VS.71).aspx
#
...
if(DEFINED CSHARP_DOTNET_FOUND)
  # The .NET compiler has already been found It may have been reset by the user,
...
string(REPLACE "\\" "/" csharp_dotnet_framework_dir
               ${csharp_dotnet_framework_dir})
file(GLOB_RECURSE csharp_dotnet_executables
...
foreach(csharp_dotnet_executable ${csharp_dotnet_executables})
  if(csharp_dotnet_valid)
    ...
    string(REPLACE "${csharp_dotnet_framework_dir}/" ""
                   csharp_dotnet_version_temp ${csharp_dotnet_executable})
    string(REPLACE "/csc.exe" "" csharp_dotnet_version_temp
...
if(CSHARP_DOTNET_FOUND)
  ...
  message(
    STATUS "Found the following C# .NET versions: ${CSHARP_DOTNET_VERSIONS}")

  # Set the compiler version Do not force, so that the user can manually select
  # their own version if they wish
  if(DEFINED CSHARP_DOTNET_COMPILER_v2.0.50727)
    # If available, select .NET v2.0.50727 (this is the minimal version as it
    # supports generics, and allows use of VS2008)
...
set(DotNetFrameworkSdk_USE_FILE
