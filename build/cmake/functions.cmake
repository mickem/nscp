...
macro(NSCP_ADD_TEST name target)
  if(WIN32)
    add_test(NAME ${name} COMMAND ${BUILD_TARGET_ROOT_PATH}/${target})
  else()
...
macro(SET_LIBRARY_OUT_FOLDER _TARGET)
  if(MSVC11
     ...
     OR MSVC14
     OR APPLE)
    set_target_properties(${_TARGET} PROPERTIES RUNTIME_OUTPUT_DIRECTORY
                                                ${BUILD_TARGET_EXE_PATH})
    set_target_properties(${_TARGET} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_DEBUG
                                                ${BUILD_TARGET_EXE_PATH})
    set_target_properties(${_TARGET} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_RELEASE
                                                ${BUILD_TARGET_EXE_PATH})
    set_target_properties(
      ${_TARGET} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO
                            ${BUILD_TARGET_EXE_PATH})
  endif()
...
macro(SET_LIBRARY_OUT_FOLDER_MODULE _TARGET)
  if(MSVC11
    ...
    set_target_properties(${_TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY
                                                ${BUILD_TARGET_EXE_PATH})
    set_target_properties(${_TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_DEBUG
                                                ${BUILD_TARGET_EXE_PATH})
    set_target_properties(${_TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELEASE
                                                ${BUILD_TARGET_EXE_PATH})
    set_target_properties(
      ${_TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO
                            ${BUILD_TARGET_EXE_PATH})
  endif()
...
macro(NSCP_INSTALL_MODULE _TARGET)
  ...
  if(MSVC11
    ...
    set_target_properties(
      ${TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_DEBUG
                           ${BUILD_TARGET_ROOT_PATH}/${_FOLDER})
    set_target_properties(
      ${TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELEASE
                           ${BUILD_TARGET_ROOT_PATH}/${_FOLDER})
    set_target_properties(
      ${TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO
                           ${BUILD_TARGET_ROOT_PATH}/${_FOLDER})
  endif()
endmacro()
...
macro(NSCP_MAKE_LIBRARY _TARGET _SRCS)
  if(USE_STATIC_RUNTIME)
    ...
    if(CMAKE_COMPILER_IS_GNUCXX
      ...
      AND "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64"
      AND NOT APPLE)
    set_target_properties(${_TARGET} PROPERTIES VERSION "${NSCP_LIB_VERSION}")
  ...
  if(NOT USE_STATIC_RUNTIME)
    ...
    if(MSVC11
      ...
      set_target_properties(${_TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_DEBUG
                                                  ${BUILD_TARGET_ROOT_PATH})
      set_target_properties(
        ${_TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELEASE
                              ${BUILD_TARGET_ROOT_PATH})
      set_target_properties(
        ${_TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO
                              ${BUILD_TARGET_ROOT_PATH})
