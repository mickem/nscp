...
macro(SET_LIBRARY_OUT_FOLDER_MODULE _TARGET)
    if(MSVC11 OR MSVC12 OR MSVC13 OR MSVC14 OR APPLE)
        set_target_properties(
            ${_TARGET}
            PROPERTIES LIBRARY_OUTPUT_DIRECTORY ${BUILD_TARGET_EXE_PATH}/modules
        )
        set_target_properties(
            ${_TARGET}
            PROPERTIES LIBRARY_OUTPUT_DIRECTORY_DEBUG ${BUILD_TARGET_EXE_PATH}/modules
        )
        set_target_properties(
            ${_TARGET}
            PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELEASE ${BUILD_TARGET_EXE_PATH}/modules
        )
        set_target_properties(
            ${_TARGET}
            PROPERTIES
                LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO ${BUILD_TARGET_EXE_PATH}/modules
        )
    endif()
