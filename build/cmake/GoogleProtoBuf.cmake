...
function(WRAP_PROTO VAR)
  ...
  foreach(FIL ${ARGN})
    ...
    if(PROTOC_GEN_LUA_FOUND)
      ...
      list(APPEND ARGS --lua_out ${PROJECT_BINARY_DIR}/libs/lua_pb
    ...
    if(PROTOC_GEN_MD_FOUND AND PROTOBUF_PROTOC_VERSION STREQUAL "2.6.1")
      ...
      list(APPEND ARGS --md_out ${BUILD_ROOT_FOLDER}/docs/docs/api
           ${PROTOC_GEN_MD_EXTRA})
    ...
    if(WIN32)
      ...
      add_custom_command(
        ...
        COMMAND ${PROTOBUF_PROTOC_EXECUTABLE} ARGS ${ARGS} --proto_path
