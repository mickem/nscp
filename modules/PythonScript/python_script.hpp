...
struct python_script : public boost::noncopyable {
	...
	python_script(unsigned int plugin_id, const std::string base_path, const std::string plugin_alias, const std::string script_alias, const boost::filesystem::path script);
	~python_script();
