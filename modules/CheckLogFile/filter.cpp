...
logfile_filter::filter_obj_handler::filter_obj_handler() {
  registry_.add_string_var("line", &filter_obj::get_line, "Match the content of an entire line")
      .add_string_var(
      ...
      .add_string_var("filename", &filter_obj::filename, "The name of the file")
      .add_string_var("file", &filter_obj::filename, "The name of the file");
