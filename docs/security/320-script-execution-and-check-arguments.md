...
fixed_in: next
severity: "Low"
modules: [CheckExternalScripts, CheckDocker, NSClientServer, CheckDisk, CheckWMI, CheckMySQL, CheckMSSQL, docs]
action: conditional
---
Six findings from a review of the script launcher and the checks that take a
