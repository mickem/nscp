---
title: "Script execution and check arguments: NUL truncation, import sandbox, pipe reads, handle leak, docker endpoint"
fixed_in: next
severity: "Low"
modules: [CheckExternalScripts, CheckDocker, NSClientServer, CheckDisk]
action: conditional
---
