...
| [debug](#check_wmi_debug)                   | 1)] (=0       | Show debugging information in the log                                                                                     |
| [show-all](#check_wmi_show-all)             | 1)] (=0       | Show details for all matches regardless of status (normally details are only showed for warnings and criticals).          |
...
| [escape-html](#check_wmi_escape-html)       | 1)] (=0       | Escape any < and > characters to prevent HTML encoding                                                                    |
