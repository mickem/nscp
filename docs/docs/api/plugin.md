...
`Plugin.Common.PerformanceData.IntValue`
...
`Plugin.Common.PerformanceData.StringValue`
...
`Plugin.Common.PerformanceData.FloatValue`
...
`Plugin.Common.PerformanceData.BoolValue`
...
`Plugin.ScheduleNotificationMessage`
...
`Plugin.ScheduleNotificationMessage.Request`
